...
export default function getDatasetList(api) {
    ...
    var list = {
        'difo': {
            ...
            cluster: true,
            template: getDatasetTemplate('digitalt_fortalt'),
        ...
        'verneomr': {
            ...
            provider: 'Naturbase',
            name: 'Verneområder',
            template: getDatasetTemplate('verneomraader'),
        ...
        'artobs': {
            ...
            template: getDatasetTemplate('popup')
        },
        'folketelling': {
            ...
            isStatic: false,
            minZoom: 14,
            template: getDatasetTemplate('folketelling'),
            ...
            datasets: [
                {
                    ...
                    template: getDatasetTemplate('musit')
                },
                {
                    name: 'DiMu',
                    dataset: {
                    ...
                    template: getDatasetTemplate('digitalt_museum'),
                    isStatic: false
                }/*,
                {
                    id: 'riksantikvaren',
                    ...
                    template: getDatasetTemplate('ra_sparql'),
                    bbox: false,
                    isStatic: false,
                    unclusterCount: 20,
        ...
        'historie': {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    isStatic: false,
                    bbox: false,
                    template: getDatasetTemplate('foto_sf')
                },
                {
                    dataset: {
                        api: 'norvegiana',
        ...
        'wikipedia': {
            ...
            minZoom: 13,
            template: getDatasetTemplate('wikipedia'),
        ...
        'brukerminner': {
            ...
            template: getDatasetTemplate('brukerminne'),
            style: {
                fillcolor: '#436978',
                circle: false,
                thumbnail: false
        ...
        'groruddalen': {
            ...
            isStatic: false,
            style: {thumbnail: true},
            template: getDatasetTemplate('byantikvaren_oslo'),
        ...
        'kulturminnesok_flickr': {
            ...
            template: getDatasetTemplate('flickr'),
            isStatic: true,
            style: {thumbnail: true},
